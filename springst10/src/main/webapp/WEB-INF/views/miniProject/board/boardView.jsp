...
<c:import url="/WEB-INF/views/miniProject/include/top_menu.jsp" />
			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<img src="/WEB-INF/img/logo.png" width="100%"/>						
					</div>
					<div class="form-group">
						<div class="text-right">
							<a href="testBoardMain.do" class="btn btn-primary">목록보기</a>
							<a href="testBoardModify.do" class="btn btn-info">수정하기</a>
							<a href="testBoardDelete.do" class="btn btn-danger">삭제하기</a>
						</div>
					</div>
				</div>
			</div>
...
<c:import url="/WEB-INF/views/miniProject/include/bottom_info.jsp"/>
